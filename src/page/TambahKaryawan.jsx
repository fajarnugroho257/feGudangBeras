          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Manajemen data dan gaji karyawan operasional
              </p>
            </div>
            {/* <button
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-gray-50/80 border-b border-gray-200">
                      <th className="py-3 px-4 text-[11px] font-bold text-gray-500 uppercase tracking-wider text-center border-r border-gray-200 w-16">
                        No
                      </th>
                      <th className="py-3 px-4 text-[11px] font-bold text-gray-500 uppercase tracking-wider border-r border-gray-200">
                        Nama Karyawan
                      </th>
                      <th className="py-3 px-4 text-[11px] font-bold text-gray-500 uppercase tracking-wider text-center w-32">
                        Aksi
                      </th>
                    </tr>
                  </thead>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="p-5 border-t border-gray-100 bg-white flex justify-end gap-3">
                <button
                  type="button"
                  onClick={() => handleModalAdd()}
                  className="px-5 py-2 bg-white border border-gray-200 text-gray-700 rounded-lg text-sm font-semibold hover:bg-gray-50 transition-colors shadow-sm"
                >
                  Batal
                </button>
                <button
                  type="submit"
                  className="px-5 py-2 bg-teal-600 text-white rounded-lg text-sm font-semibold hover:bg-teal-700 transition-colors shadow-sm flex items-center gap-2"
                >
          ...
          <div className="bg-white w-full max-w-4xl h-full max-h-[90vh] rounded-2xl shadow-2xl relative z-10 flex flex-col overflow-hidden">
            ...
            <div className="flex justify-between items-center p-5 border-b border-gray-100 bg-white shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-bold text-gray-800 leading-tight">
                    Slip Gaji: {karyawanNama}
                  </h2>
                  <p className="text-xs text-gray-500">
                    Kelola operasional dan gaji karyawan
                  </p>
                </div>
              </div>
              <button
              ...
              <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex flex-col sm:flex-row justify-between items-end sm:items-center gap-4 mb-5">
                <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                  <div className="flex flex-col">
                    <label className="text-[10px] font-bold text-gray-500 mb-1 uppercase">
                      Dari Tanggal
                    </label>
                    <input
                      name="dateFrom"
                  ...
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="bg-gray-50/80 border-b border-gray-200">
                        ...
                        <th className="py-3 px-4 text-[11px] font-bold text-gray-500 uppercase tracking-wider border-r border-gray-200 w-40">
                          Tanggal
                        </th>
                        <th className="py-3 px-4 text-[11px] font-bold text-gray-500 uppercase tracking-wider text-right border-r border-gray-200 w-48">
                          Jumlah Gaji (Rp)
                        </th>
                        <th className="py-3 px-4 text-[11px] font-bold text-gray-500 uppercase tracking-wider text-center border-r border-gray-200 w-32">
                          Status Lunas
                        </th>
                        <th className="py-3 px-4 text-[11px] font-bold text-gray-500 uppercase tracking-wider text-center w-48">
                          Terakhir Update
                        </th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-100">
                      {dataGaji && dataGaji.length > 0 ? (
                        dataGaji.map((item, index) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="py-3 px-4 text-right text-sm text-gray-800 font-bold border-r border-gray-100">
                                {RupiahFormat(item.beban_value)}
                              </td>
                        ...
                        <tr>
                          <td
                            colSpan="5"
                            className="text-center py-6 text-gray-500 italic bg-gray-50 rounded-lg"
                          >
                            Data gaji tidak ditemukan
                          </td>
                        </tr>
              ...
              {dataGaji.length > 0 && (
                <div className="bg-teal-50/50 border border-teal-200 rounded-xl p-4 shadow-sm flex justify-between items-center">
                  <span className="text-sm font-bold text-teal-900 uppercase">
                    Total Gaji ({dataGaji.length} Hari)
                  </span>
                  <span className="text-xl font-bold text-teal-700">
                    {RupiahFormat(
                      dataGaji.reduce(
                        (acc, curr) => acc + parseInt(curr.beban_value),
                        0,
                      ),
                    )}
                  </span>
